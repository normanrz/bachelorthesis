...
\setmainfont[
            ...
            Numbers           = OldStyle,
            Ligatures=TeX]{OpenSans-Regular}
...
\newcommand{\docTitleDE}{Entwicklung einer web-basierten ereignis-gesteuerten Clientantwendung-Architektur für "Project Zoom"}
\newcommand{\docSupervisited}{Prof. Dr. Holger Giese, Gregor Berg M.Sc. und Thomas Behyl, M.Sc.}
...
\begin{document}
	...
	%\include{src/Grundlagen}
	
	%\include{src/Hauptteil}
