...
\newcommand{\docTitle}{The design of a web-based event-driven client application architecture for Project Zoom}
...
\setheadsepline{1.0pt}[\color{black!70}] \setfootsepline{1.0pt}[\color{black!70}]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Glossary
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\makeglossaries
